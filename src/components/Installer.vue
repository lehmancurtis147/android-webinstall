    ...
    <v-stepper
        ...
        <v-stepper-items class="d-flex flex-column flex-grow-1">
            <v-stepper-content step="-1" :class="
                ...
                ">
                <prepare-step :device="device" :blob-store="blobStore" :active="curStep === -1"/>
            </v-stepper-content>

            <v-stepper-content step="0" :class="
                    curStep === 0 ? 'd-flex flex-column flex-grow-1' : null
                ">
                <install-type-step :device="device" :blob-store="blobStore" :active="curStep === 0"/>
            </v-stepper-content>
            ...
            <v-stepper-content step="2" :class="
                ...
                ">
                <unlock-step :device="device" :blob-store="blobStore" :curStep="curStep" stepNum="2"/>
            </v-stepper-content>

            <v-stepper-content step="3" :class="
                    curStep === 3 ? 'd-flex flex-column flex-grow-1' : null
                ">
                <download-step :device="device" :blob-store="blobStore" :active="curStep === 3"/>
            </v-stepper-content>

            <v-stepper-content step="4" :class="
                    curStep === 4 ? 'd-flex flex-column flex-grow-1' : null
                ">
                <install-step :device="device" :blob-store="blobStore" :active="curStep === 4"/>
            </v-stepper-content>

            <v-stepper-content step="5" :class="
                    curStep === 5 ? 'd-flex flex-column flex-grow-1' : null
                ">
                <finish-step :device="device" :blob-store="blobStore" :active="curStep === 5"/>
            </v-stepper-content>
        </v-stepper-items>
    </v-stepper>
    ...
    <v-dialog v-model="disconnectDialog" width="500" persistent>
        <v-card>
            ...
            <v-card-text>
                ...
                <connect-banner :device="device" :connecting="disconnectReconnecting" :error="disconnectReconnectError"/>
            </v-card-text>
