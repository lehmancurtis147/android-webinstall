...
<v-container class="d-flex justify-space-between flex-column flex-grow-1">
    <div class="mt-n4">
        ...
        <div class="text-body-1">
            <p>
                ...
                {{ $root.$data.OS_NAME }}
                or switch to it from another OS, but you need to choose which one you want.
            </p>
        </div>
    </div>
    ...
    <div class="d-flex flex-wrap justify-space-around">
        <v-card
            ...
            <v-card-subtitle >Switch from the stock OS or another ROM to
                {{ $root.$data.OS_NAME }}.
        ...
        <v-card
            ...
            <div>
                <v-card-title class="mt-n2">
                    ...
                    Update</v-card-title >
                <v-card-subtitle >Update from an older version of
    ...
    <div class="d-flex justify-space-between flex-row-reverse">
        <v-btn color="primary" @click="$bubble('nextStep')" :disabled="$root.$data.installType === null">Next
