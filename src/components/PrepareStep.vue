...
<v-container class="d-flex justify-space-between flex-column flex-grow-1">
    ...
    <div class="mb-10 mt-n4" v-else>
        ...
        <div class="text-body-1">
            <p>
                ...
                {{ $root.$data.OS_NAME }}
                because your browser doesn’t support WebUSB. Only Google Chrome and other browsers based on Chromium, such Brave and Microsoft Edge, are supported.
            </p>
        </div>
    ...
    <div class="d-flex justify-space-between flex-row-reverse">
        <v-btn color="primary" @click="$bubble('nextStep')" :disabled="!usbSupported">
            Start
