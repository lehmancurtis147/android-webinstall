...
<v-container class="d-flex justify-space-between flex-column flex-grow-1">
    <div class="mt-n4">
        ...
        <div class="text-body-1">
            <p>
                In order to install custom software, you need to unlock your device’s bootloader.
            </p>
            <p>
                If this is your first time or you haven’t already turned on OEM unlocking:
            </p>
            <ol class="ml-4 mb-8">
    ...
    <div class="mb-4">
        ...
        <v-banner single-line outlined rounded class="mt-4" v-else-if="unlocking">
            <v-progress-circular slot="icon" indeterminate color="primary"></v-progress-circular>
            <span class="text-body-1">Unlocking bootloader… Confirm using the volume and power buttons.</span >
        </v-banner>
    ...
    <div class="d-flex justify-space-between flex-row-reverse">
        <v-btn color="primary" @click="$bubble('nextStep')" :disabled="!unlocked">Next
    ...
    <v-dialog v-model="oemUnlockDialog" width="500" persistent>
        <v-card>
            ...
            <v-card-text>
                <p>
                    For security reasons, bootloader unlock isn’t allowed by default. Enable OEM unlocking to allow it:
                </p>
                ...
                <p>
                    Once you’ve enabled OEM unlocking, try unlocking the bootloader again.
                </p>
            </v-card-text>
