...
<v-container class="d-flex justify-space-between flex-column flex-grow-1">
    <div class="mb-10 mt-n4">
        ...
        <div class="text-body-1">
            <p>
                Put your device into bootloader mode by turning it off, then holding the
                <strong>power</strong>
                and
                <strong>volume down</strong>
                buttons together until you see a
            ...
            <p>
                Once your device is in bootloader mode, plug it into the computer or device you’re installing from. Make sure you use a
        ...
        <v-btn :color="$root.$data.product === null ? 'primary' : null" @click="connect" :disabled="connecting">Connect</v-btn >
    </div>

    <div class="mb-4">
        <connect-banner :device="device" :connecting="connecting" :error="error"/>
    </div>

    <div class="d-flex justify-space-between flex-row-reverse">
        <v-btn color="primary" @click="$bubble('nextStep')" :disabled="$root.$data.product === null">Next
...
import { getRecoveryVersion } from "../core/recoveries";
